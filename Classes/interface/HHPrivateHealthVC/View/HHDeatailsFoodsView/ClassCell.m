...
#import "ChooseGistVC.h"
#import "NutritionalBenefitsVC.h"
#import "PracticalEncyclopediaVC.h"
#import "BaseTableViewControllers.h"
@interface ClassCell () <UIPageViewControllerDelegate,UIPageViewControllerDataSource,UIScrollViewDelegate,BaseTableViewControllerDelegate>
...
- (void)customPageView {
    ...
    RelevantFoodVC *ctrl1 = [[RelevantFoodVC alloc] init];
    ctrl1.delegate = self;
    ChooseGistVC *ctrl2 = [[ChooseGistVC alloc] init];
    ctrl2.delegate = self;
    NutritionalBenefitsVC *ctrl3 = [[NutritionalBenefitsVC alloc] init];
    ctrl3.delegate = self;
    PracticalEncyclopediaVC *ctrl4 = [[PracticalEncyclopediaVC alloc] init];
    ctrl4.delegate = self;
...
+ (void)regisCellForTableView:(UITableView *)tableView {
    [tableView registerClass:[ClassCell class] forCellReuseIdentifier:@"cellid"];
}

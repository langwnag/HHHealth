...
//        _tapGestureRecognizer = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(tapToReply:)];
...
//-(void)tapToReply:(UITapGestureRecognizer *)sender{
//    NSLog(@"点击了label");
//    if (self.tapToReplyBlock) {
//        
//        self.tapToReplyBlock();
//    }
//}

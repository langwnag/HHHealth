...
#define kDefaultLinkColorForMLLinkLabel [UIColor colorWithRed:87.0f/255.0f green:107.0f/255.0f blue:149.0f/255.0f alpha:1.000]
...
//typedef void(^TapToReplyBlock)();

@interface MLLinkLabel : MLLabel

//@property(nonatomic,copy)TapToReplyBlock tapToReplyBlock;

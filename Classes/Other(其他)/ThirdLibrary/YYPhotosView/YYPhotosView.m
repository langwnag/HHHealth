...
- (void)addImages:(NSMutableArray *)images {
    ...
    CGFloat imgW = (self.size.width - (self.imgCountRow + 1) * ImageMargin) / self.imgCountRow;
    CGFloat imgH = imgW;
    ...
    self.superImgView.frame = CGRectMake(0, 0, self.size.width, self.imageMaxHeight + ImageMargin);

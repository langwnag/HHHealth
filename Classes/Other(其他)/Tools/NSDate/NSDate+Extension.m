...
-(NSDate *)currentNowDate{
    NSTimeZone * zone = [NSTimeZone systemTimeZone];
    return [self dateByAddingTimeInterval:[zone secondsFromGMTForDate:self]];
}
...
// 字符串转时间戳
+(long long)timeStampWithString:(NSString *)string{
    return (long long)[[NSDate dateWithString:string format:@"yyyy-MM-dd"] timeIntervalSince1970] * 1000;
}
...
/* 通过时间戳, 返回更新时间 */
+ (NSString *)updateTime:(long long)timeStamp{
